...
After logging into https://visnav-ss23.gitlab.vision.in.tum.de you should
...
```
git clone --recursive git@visnav-ss23.gitlab.vision.in.tum.de:visnav_ss23/<username>/visnav.git
```
